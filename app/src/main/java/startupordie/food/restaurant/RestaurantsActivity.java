...
public class RestaurantsActivity extends BaseActivity implements ObservableScrollViewCallbacks {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mFab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(RestaurantsActivity.this, "FAB is clicked", Toast.LENGTH_SHORT).show();
            }
        });
