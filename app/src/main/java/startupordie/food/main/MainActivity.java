package startupordie.food.main;
...
import startupordie.food.data.Categories;
import startupordie.food.food.FoodsContract;
import startupordie.food.food.FoodsFragment;
import startupordie.food.food.FoodsPresenter;
import startupordie.food.hotel.HotelsContract;
...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        startDetailsFragment(Categories.FOODS);
    }

    private void startDetailsFragment(Categories categories) {
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camera) {
            ...
            startDetailsFragment(Categories.HOTELS);
